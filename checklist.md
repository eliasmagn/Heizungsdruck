...
- [x] 2026-05-11 Follow-up 12: WireGuard-Semantik bereinigt: Pflichtvalidierung auf echte Runtime-Felder reduziert, `online` klar als Heuristik geführt, `lastHandshake` als backend-unverfügbar gekennzeichnet, `lastError`/`lastInfo` getrennt, Disable-/Fehlerpfade räumen Statusfelder vollständig auf.
